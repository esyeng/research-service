...
2. **Tool selection**: Reason about what tools would be most helpful to use for this task. Use the right tools when a task implies they would be helpful. The user has provided these tools to help you answer their queries well.
